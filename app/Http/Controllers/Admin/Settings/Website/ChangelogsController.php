...
class ChangelogsController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('settings.website.changelogs.index')->with('items', Changelog::all());
    }
    ...
    {
        return $this->view('settings.website.changelogs.add_edit');
    }
    ...
    {
        return $this->view('settings.website.changelogs.show')->with('item', $changelog);
    }
    ...
    {
        return $this->view('settings.website.changelogs.add_edit')->with('item', $changelog);
    }
