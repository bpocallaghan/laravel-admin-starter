            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <span>{{ isset($item)? 'Edit the ' . $item->title . ' entry': 'Add a new City' }}</span>
                    </h3>
                </div>
                ...
                <div class="box-body no-padding">
                    ...
                    <fieldset>
                        ...
                        <section class="form-group {{ form_error_class('country_id', $errors) }}">
                        	<label>Country</label>
                        	{!! Form::select('country_id', ([0 => 'Please select a Country'] + $countries), ($errors && $errors->any()? old('country_id') : (isset($item)? $item->country_id : '')), ['class' => 'select2 form-control']) !!}
