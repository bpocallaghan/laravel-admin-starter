            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <span>{{ isset($item)? 'Edit the ' . $item->title . ' entry': 'Create a new AnnualReport' }}</span>
                    </h3>
                </div>
                    ...
                    <form method="POST" action="{{$selectedNavigation->url . (isset($item)? "/{$item->id}" : '')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group {{ form_error_class('content', $errors) }}">
                                <label for="annual-content">Content</label>
                                <textarea class="form-control summernote" id="annual-content" name="content" rows="18">{{ ($errors && $errors->any()? old('content') : (isset($item)? $item->content : '')) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ form_error_class('file', $errors) }}">
                                        <label>Upload your Annual Report (Max 5MB)</label>
