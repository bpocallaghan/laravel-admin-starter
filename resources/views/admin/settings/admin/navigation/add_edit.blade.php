        ...
        <div class="col-xs-12">
            <div class="box box-primary box-solid">
                ...
                <div class="box-body no-padding">
                    ...
                    {!! Form::open(['method' => isset($item)? 'put':'post', 'id' => 'form-edit', 'url' => $selectedNavigation->url . (isset($item)? $item->id : '')]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col col-9">
                                <section class="form-group {{ form_error_class('help_index_content', $errors) }}">
                                    <label for="id-help_index_content">Help Index Content</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col col-9">
                                <section class="form-group {{ form_error_class('help_create_content', $errors) }}">
                                    <label for="id-help_create_content">Help Create Content</label>
